    ...
    <div className="py-10 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-900 mt-2">Kelola jadwal dokter, koneksi WhatsApp, dan pengingat</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-sm text-gray-900">Visualisasi jadwal dokter dengan FullCalendar</p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-gray-900">Scan QR Code untuk mengaktifkan pengingat WhatsApp</p>
          </Link>
        </div>
      </div>
    </div>
