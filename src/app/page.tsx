...
export default function Home() {
  return (
    <div className="flex flex-col">
      <section className="bg-gradient-to-br from-sky-400 via-sky-500 to-blue-500 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            ...
            <Link
              href="/chat"
              className="px-6 py-3 bg-sky-400 text-white font-semibold rounded-lg hover:bg-sky-300 transition border border-sky-300"
            >
              Tanya AI Asisten
            </Link>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-sky-100">
            ...
            <p className="text-sm text-gray-500">Registrasi, pilih dokter, tanggal, dan jam dengan 4 langkah mudah.</p>
          </div>
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-sky-100">
            ...
            <p className="text-sm text-gray-500">Tanya jadwal & booking dokter via chat. Bot responsif 24/7 tanpa API key.</p>
          </div>
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-sky-100">
            ...
            <p className="text-sm text-gray-500">Notifikasi otomatis H-1 dan 1 jam sebelum janji temu via WhatsApp.</p>
          </div>
        </div>
      </section>
    </div>
